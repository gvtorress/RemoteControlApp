...
export function SendText(props){
  ...
  async function saveIP() {
      ...
      await AsyncStorage.setItem(COLLECTION_IPLIST, JSON.stringify([...ipList, text]))
  }
  ...
  async function testIP() {
      ...
      await api.get('/').then(() => {
        ...
        alert("Failed to connect to the server, check inserted IP address")
        console.log("Erro")})
      setText("")
  }
  ...
  return (
    <View style={styles.container}>
        ...
        <TouchableOpacity onPress={props.screen === "Home" ? () => writeText() : () => testIP()}>
